...
- Create Angular project with ng: `ng new angularapp_dashboard.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularapp_dashboard.client.esproj`).
